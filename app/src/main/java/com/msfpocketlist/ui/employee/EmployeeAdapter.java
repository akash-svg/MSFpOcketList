...
public class EmployeeAdapter extends RecyclerView.Adapter<EmployeeAdapter.ViewHolder> {
    ...
    List<Employee> pocketEmList;
    Context context;
    OnItemClick onItemClick;

    public EmployeeAdapter(List<Employee> pocketEmList, Context context, OnItemClick onItemClick) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        Employee dataset = pocketEmList.get(position);
    ...
    public void searchList(List<Employee> filteredList) {
    ...
    public interface OnItemClick{
        void onHqItemClick(Employee pocketEm);
        void onOfflineCall(Employee pocketEm);
        void onOnlineCall(Employee pocketEm);
        void onMsgOne(Employee pocketEm);
        void onMsgTwo(Employee pocketEm);
    }
}
